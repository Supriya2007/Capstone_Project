...
//search without iterator on student list; 
...
{
	struct list l;
	//char names[][50] = {"anjali", "supriya", "afreen"};
	//char srns[][14] = {"PES2201800032", "PES2201800270", "PES2201800680"};
	char *names[] = {"anjali", "supriya", "afreen"};	
	char *srns[14] = {"PES2201800032", "PES2201800270", "PES2201800680"};
	int sems[] = {7, 7, 7};
	int secs[] = {'D', 'B', 'B'};
	//struct student stud_arr[] = { { "anjali", "PES2201800032", 7, 'D'}, { "supriya", "PES2201800270", 7, 'B'}, { "afreen", "PES2201800680", 7, 'B'}};
