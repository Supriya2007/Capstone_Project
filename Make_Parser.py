...
states = {
    ...
    'function_header' : ['p_function_declaration', 824],
    'function_parameters' : ['p_parameter_type_list', 877],
    'parameter_declaration' : ['p_parameter_declaration', 905],
    'func_statements' : ['p_statement', 1024],
    'function_end' : ['p_function_definition', 1255],
    'var_declares' : ['p_variable_declaration1', 788],
    'declarations' : ['p_other_declarations', 1211], 
    #Maps to declarations outside functions = global variables and function prototypes
    'declaration_stmt' : ['p_declaration', 459],
    ...
    'loop_header':['p_iteration_header', 1139],
    'loop_body':['p_iteration_body', 1163],
    'after_parse':['after_parse_main', 1291],
    'switch_stmt': ['p_selection_statement', 1117],
    'case_stmt':['p_labeled_statement', 1036],
    'equality_cond' : ['p_equality_expression', 265],
    'equality_cond_lhs' : ['p_equality_exp_lhs', 282],
    'variable_assignments' : ['p_assignment_expression', 390],
    'assignment_lhs' : ['p_assignment_lhs', 408],
    'postfix_expression' : ['p_postfix_expression', 73],
    'unary_expression' : ['p_unary_expression', 123],
    'identifier_list':['p_identifier_list', 920],
    'unintialized_declaration':['p_uninitialized_declaration', 538],
    'initialized_declaration': ['p_initialized_declaration', 518],
    'expressions':['p_expression_statement', 1099],
    'functions_without_type_specifiers':['p_fheader_type2', 1245],
