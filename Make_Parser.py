...
states = {
    ...
    'function_prototype' : ['p_function_declaration', 902],
    #Can not differentiate between function definitions and prototypes as of now
    'function_header' : ['p_function_declaration', 902],
    'function_parameters' : ['p_parameter_type_list', 962],
    'parameter_declaration' : ['p_parameter_declaration', 999],
    'func_statements' : ['p_statement', 1126],
    #'function_end' : ['p_function_definition', 1246],
    'function_end' : ['p_function_definition', 1394],
    'var_declares' : ['p_variable_declaration1', 862],
    'variable_declaration' : ['p_variable_declaration', 847],
    'declarations' : ['p_other_declarations', 1350], 
    ...
    'loop_header':['p_iteration_header', 1268],
    'loop_body':['p_iteration_body', 1294],
    'loop_statement':['p_iteration_statement',1261],
    'after_parse':['after_parse_main', 1436],
    'switch_stmt': ['p_selection_statement', 1238],
    'if_stmt': ['p_selection_statement', 1238],
    'case_stmt':['p_labeled_statement', 1141],
    ...
    'identifier_list':['p_identifier_list', 1022],
    'unintialized_declaration':['p_uninitialized_declaration', 586],
    'initialized_declaration': ['p_initialized_declaration', 563],
    'expressions':['p_expression_statement', 1219],
    'functions_without_type_specifiers':['p_fheader_type2', 1384],
    'exp': ['p_expression', 462],
    'type_specifiers':['p_declaration_specifiers', 511],
    'jump_statement' : ['p_jump_statement',1302],
    'block_end':['p_compound_statement', 1157],
    'block_start':['p_compound_statement_begin', 1178],
