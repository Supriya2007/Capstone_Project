...
states = {
    ...
    'function_header' : ['p_function_declaration', 911],
    'function_parameters' : ['p_parameter_type_list', 971],
    'parameter_declaration' : ['p_parameter_declaration', 1008],
    'func_statements' : ['p_statement', 1135],
    #'function_end' : ['p_function_definition', 1246],
    'function_end' : ['p_function_definition', 1406],
    'var_declares' : ['p_variable_declaration1', 871],
    'variable_declaration' : ['p_variable_declaration', 856],
    'declarations' : ['p_other_declarations', 1362], 
    #Maps to declarations outside functions = global variables and function prototypes
    'declaration_stmt' : ['p_declaration', 490],
    ...
    'loop_header':['p_iteration_header', 1280],
    'loop_body':['p_iteration_body', 1306],
    'loop_statement':['p_iteration_statement',1273],
    'after_parse':['after_parse_main', 1448],
    'switch_stmt': ['p_selection_statement', 1247],
    'if_stmt': ['p_selection_statement', 1247],
    'case_stmt':['p_labeled_statement', 1150],
    'equality_cond' : ['p_equality_expression', 283],
    'equality_cond_lhs' : ['p_equality_exp_lhs', 300],
    'variable_assignments' : ['p_assignment_expression', 408],
    'assignment_lhs' : ['p_assignment_lhs', 437],
    'postfix_expression' : ['p_postfix_expression', 78],
    'unary_expression' : ['p_unary_expression', 139],
    'identifier_list':['p_identifier_list', 1031],
    'unintialized_declaration':['p_uninitialized_declaration', 590],
    'initialized_declaration': ['p_initialized_declaration', 567],
    'expressions':['p_expression_statement', 1228],
    'functions_without_type_specifiers':['p_fheader_type2', 1396],
    'exp': ['p_expression', 466],
    'type_specifiers':['p_declaration_specifiers', 515],
    'jump_statement' : ['p_jump_statement',1314],
    'block_end':['p_compound_statement', 1166],
    'block_start':['p_compound_statement_begin', 1187],
    'declarator_name':['p_declarator', 827],
    'translation_unit':['p_translation_unit',1335],
    'structures_and_unions':['p_struct_or_union_specifier',644],
    'struct_declaration_list':['p_struct_declaration_list',690],
    'type_specifier':['p_type_specifier',631],
