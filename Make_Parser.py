...
states = {
    ...
    'function_prototype' : ['p_function_declaration', 473],
    #Can not differentiate between function definitions and prototypes as of now
    #'function_header' : ['p_function_header', 615],
    'function_header' : ['p_function_declaration', 473],
    'function_parameters' : ['p_parameter_type_list', 501],
    'parameter_declaration' : ['p_parameter_declaration',515],
    'func_statements' : ['p_statement', 574],
    'function_end' : ['p_function_definition', 759],
    #'common_prefix' : ['p_common_prefix', 100],
    #'var_declares' : ['p_variable_declaration', 385],
    'var_declares' : ['p_variable_declaration1', 446],
    'declarations' : ['p_other_declarations', 695], 
    #Maps to declarations outside functions = global variables and function prototypes
    'declaration_stmt' : ['p_declaration', 240],
    ...
    'function_call' : ['p_function_call', 47],
    'loop_header':['p_iteration_header', 635],
    'loop_body':['p_iteration_body', 647],
    'after_parse':['after_parse_main', 774],
    'switch_stmt': ['p_switch_header', 303],
    'case_stmt':['p_case_header', 322],
    'variable' : ['p_variable_use' , 19],
    'equality_cond' : ['p_equality_expression', 142],
    'equality_cond_lhs' : ['p_equality_exp_lhs', 150],
    'variable_assignments' : ['p_assignment_expression', 198],
    'assignment_lhs' : ['p_assignment_lhs', 205],
    'postfix_expression' : ['p_postfix_expression', 56],
    'unary_expression' : ['p_unary_expression', 76],
    'identifier_list':['p_identifier_list',500],
