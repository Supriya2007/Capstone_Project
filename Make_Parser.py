...
states = {
    ...
    'loop_header':['p_iteration_header', 1137],
    'loop_body':['p_iteration_body', 1165],
    'after_parse':['after_parse_main', 1293],
    'switch_stmt': ['p_selection_statement', 1115],
    'case_stmt':['p_labeled_statement', 1034],
    'equality_cond' : ['p_equality_expression', 264],
    'equality_cond_lhs' : ['p_equality_exp_lhs', 281],
    'variable_assignments' : ['p_assignment_expression', 389],
    'assignment_lhs' : ['p_assignment_lhs', 407],
    'postfix_expression' : ['p_postfix_expression', 73],
    'unary_expression' : ['p_unary_expression', 123],
    'identifier_list':['p_identifier_list', 917],
